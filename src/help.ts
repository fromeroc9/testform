...
Usage: ${TITLE_CLI} [global options] init [options]
...
Usage: ${TITLE_CLI} [global options] plan [options]
...
Usage: ${TITLE_CLI} [global options] validate [options]
...
Usage: ${TITLE_CLI} [global options] apply [options] [PLAN]
...
Usage: ${TITLE_CLI} [global options] destroy [options]
...
Usage: ${TITLE_CLI} [global options] import [options] ADDR ISSUE_NUMBER
...
Usage: ${TITLE_CLI} [global options] refresh [options]
...
Usage: ${TITLE_CLI} [global options] show [options] [path]
...
Usage: ${TITLE_CLI} [global options] fmt [options] [target...]
...
Usage: ${TITLE_CLI} [global options] force-unlock LOCK_ID
...
Usage: ${TITLE_CLI} [global options] graph [options]
...
Usage: ${TITLE_CLI} [global options] login [hostname]
...
Usage: ${TITLE_CLI} [global options] logout [hostname]
...
Usage: ${TITLE_CLI} [global options] state [subcommand] [options] [args]
...
Usage: ${TITLE_CLI} [global options] state identities [options] -json [address...]
...
Usage: ${TITLE_CLI} [global options] state list [options] [address...]
...
Usage: ${TITLE_CLI} [global options] state pull [options]
...
Usage: ${TITLE_CLI} [global options] state push [options] PATH
...
Usage: ${TITLE_CLI} [global options] taint [options] [address]
...
Usage: ${TITLE_CLI} [global options] untaint [options] name
...
Usage: ${TITLE_CLI} version [options]

  Displays the version of ${TITLE_APP}.
`.trim();

export const HELP_WORKSPACE = `
Usage: ${TITLE_CLI} [global options] workspace
...
Usage: ${TITLE_CLI} [global options] diff [options]

  Show drift between local configuration and state.
`.trim();

export const HELP_REPORT = `
Usage: ${TITLE_CLI} [global options] report <type> [options]
